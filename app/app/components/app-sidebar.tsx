...
const ITEMS = [
  { label: "Home", path: $path("/dashboard"), icon: HomeIcon },
  { label: "Experiments", path: $path("/dashboard"), icon: RocketIcon, inactive: true },
            ...
            <SidebarMenu>
              {ITEMS.map((item) => (
                <SidebarMenuItem key={item.label}>
                  <NavLink to={item.path} prefetch="intent" onClick={() => setOpenMobile(false)}>
                    {({ isActive }) => (
