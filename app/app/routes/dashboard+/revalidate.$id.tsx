...
export async function loader({ params }: LoaderFunctionArgs) {
  ...
  return json<LoaderData>({ experimentId, appAddress: appAddress!, experiment });
}
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="font-geist text-3xl font-bold text-foreground">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="glass rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-geist text-sm font-medium text-muted-foreground">Description</h3>
          ...
          <div className="glass rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="csv-upload" className="font-geist mb-2 block text-sm font-medium text-foreground">
                ...
                <input
                  ...
                  className="font-geist block w-full text-sm text-muted-foreground
              ...
              {csvData.length > 0 && (
                <div className="rounded-md bg-muted p-3">
                  <h3 className="font-geist mb-2 text-sm font-medium text-foreground">
                    Preview:
                  </h3>
              ...
              <button
                ...
                className="font-geist w-full rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Submit Revalidation
              </button>
            </div>
